    ...
    <head>
        ...
        <style>
            ...
            .slider-item {
                position: relative;
                width: 100%;
                height: 100%; /* Đảm bảo không bị kéo dài */
            }

            .slider-item img {
                width: 100%;
                height: 100%;
                object-fit: cover; /* Hiển thị toàn bộ ảnh mà không bị kéo giãn */
            }
            ...
            .swiper-button-next,
            .swiper-button-prev {
                color: #afacac !important; /* Màu đen */
                /* Nền trắng mờ */
                padding: 10px;
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <a href="https://example.com/online-learning" target="_blank">
                                        <img src="https://images.unsplash.com/photo-1560264280-88b68371db39" alt="Online Learning">
                                    </a>
                                </div>
                            </div>
                            <!-- Slide 2 -->
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <a href="https://example.com/group-learning" target="_blank">
                                        <img src="https://images.unsplash.com/photo-1556761175-4b46a572b786" alt="Group Learning">
                                    </a>
                                </div>
                            </div>
                            <!-- Slide 3 -->
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <a href="https://example.com/programming" target="_blank">
                                        <img src="https://images.unsplash.com/photo-1587620962725-abab7fe55159?q=80&w=2062&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Programming">
                                    </a>
                                </div>
                            </div>
                            <!-- Slide 4 -->
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <a href="https://example.com/creative-learning" target="_blank">
                                        <img src="https://images.unsplash.com/photo-1587620962725-abab7fe55159?q=80&w=2062&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Creative Learning">
                                    </a>
                                </div>
                            </div>
                        </div>
