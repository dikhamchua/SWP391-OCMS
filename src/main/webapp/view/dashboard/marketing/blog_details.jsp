...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <meta name="description" content="SkillGro - Blog Details">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="title" name="title"
                                                    required maxlength="255" value="${blog.title}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="briefInfo" name="brief_info"
                                                    rows="3" required maxlength="500">${blog.briefInfo}</textarea>
                                                ...
                                                <select class="form-control" id="categoryId" name="category_id" required>
                                                    ...
                                                    <c:forEach var="category" items="${blogCategoryMap}">
                                                        <option value="${category.key}" 
                                                            ${category.key == blog.categoryId ? 'selected' : ''}>
                                                            ${category.value.name}
                                                        </option>
                                                    </c:forEach>
                                                </select>
