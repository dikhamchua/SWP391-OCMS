...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <meta name="description" content="SkillGro - Manage Settings">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" id="searchFilter" name="search"
                                                       placeholder="Search settings..." value="${param.search}">
                                            </div>
                                            <div class="col-md-3">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="dashboard__review-action">
                                                                    ...
                                                                    <a href="#" onclick="confirmDeactivate(${setting.id})"
                                                                       title="Deactivate"><i class="skillgro-bin"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
