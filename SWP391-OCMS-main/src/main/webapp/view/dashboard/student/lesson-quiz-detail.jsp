                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <div class="dashboard__content-wrap">
                                        <div
                                            class="dashboard__content-title d-flex justify-content-between align-items-center">
                                            <h4 class="title">Bài kiểm tra</h4>
                                            <a href="${pageContext.request.contextPath}/course-detail?id=${course.id}"
                                                class="btn" style="background-color: #f5f5f5; border: none;">
                                        ...
                                        <div class="row">
                                                ...
                                                <c:choose>
                                                    <c:when test="${quizResult != null}">
                                                        ...
                                                        <div class="quiz-result-container">
                                                            <div class="quiz-result-header">
                                                                <span
                                                                    class="quiz-result-status ${quizResult.passed ? 'passed' : 'failed'}">
                                                                    <i
                                                                        class="fa ${quizResult.passed ? 'fa-check-circle' : 'fa-times-circle'}"></i>
                                                                    ${quizResult.passed ? 'Đã hoàn thành' : 'Chưa hoàn
                                                                    thành'}
                                                                </span>
                                                            ...
                                                            <div class="quiz-result-details">
                                                                <div class="quiz-result-detail-item">
                                                                    <div class="quiz-result-detail-number">
                                                                        ${quizResult.totalQuestions}</div>
                                                                    <div class="quiz-result-detail-label">Tổng số câu
                                                                        hỏi</div>
                                                                </div>
                                                                <div class="quiz-result-detail-item">
                                                                    <div class="quiz-result-detail-number">
                                                                        ${quizResult.correctAnswers}</div>
                                                                    <div class="quiz-result-detail-label">Câu trả lời
                                                                        đúng</div>
                                                                </div>
                                                                <div class="quiz-result-detail-item">
                                                                    <div class="quiz-result-detail-number">
                                                            ...
                                                            <div class="quiz-result-actions">
                                                                <c:choose>
                                                                    <c:when test="${quizResult.passed}">
                                                                        <a href="${pageContext.request.contextPath}/lesson?action=view&id=${nextLesson.id}"
                                                    ...
                                                    <c:when test="${hasPassed}">
                                                        ...
                                                        <div class="quiz-result-container">
                                                            ...
                                                            <p>Bạn đã hoàn thành bài kiểm tra này thành công và có thể
                                                                tiếp tục sang bài học tiếp theo.</p>
                                                    ...
                                                    formatTime(seconds) {
                                                        ...
                                                        return `${mins}:${secs < 10 ? '0' : ''}${secs}`;
                                                            ...
                                                            <form id="quizForm"
                                                                action="${pageContext.request.contextPath}/submit-quiz"
                                                                method="post">
                                                                <input type="hidden" name="lessonQuizId"
                                                                    value="${lessonQuiz.id}">
                                                                ...
                                                                <c:forEach var="question" items="${listQuestions}"
                                                                    ...
                                                                    <div class="question-container"
                                                                        x-show="currentQuestion === ${status.index + 1}"
                                                                        x-cloak>
                                                                        <div class="question-number">
                                                                            <span>Câu hỏi ${status.index + 1}</span>
                                                                            <span>Tổng số câu hỏi:
                                                                                ${listQuestions.size()} | Điểm:
                                                                        ...
                                                                        <div class="options-container">
                                                                            <c:forEach var="answer"
                                                                                items="${questionAnswersMap[question]}">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="course-outline">
                                                    <h4 class="course-outline-title">Nội dung khóa học: ${course.name}
                                                    </h4>
                                                    ...
                                                    <c:forEach var="courseSection" items="${courseSections}">
                                                        <div x-data="{open: ${courseSection.id == section.id}}">
                                                            ...
                                                            <div x-show="open" x-transition>
                                                                <c:forEach var="sectionLesson"
                                                                    items="${sectionLessons[courseSection.id]}">
                                                                    <div
                                                                        class="outline-item ${sectionLesson.id == lesson.id ? 'active' : ''}">
                                                                        ...
                                                                        <div class="outline-item-content">
                                                                            ...
                                                                            <div class="outline-item-title">
                                                                                <a
                                                                                    href="${pageContext.request.contextPath}/lesson?action=view&id=${sectionLesson.id}">
                                                                                    ${sectionLesson.title}
                                                                                </a>
                                                                            ...
                                                                            <div class="outline-item-duration">
                                                                                ${sectionLesson.durationMinutes} min
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </c:forEach>
