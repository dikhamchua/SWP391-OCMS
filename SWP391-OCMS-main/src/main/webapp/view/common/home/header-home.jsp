                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <ul class="tg-header__top-info list-wrap">
                                <li><img src="${pageContext.request.contextPath}/assets/img/icons/map_marker.svg"
                                        alt="Icon"> <span>589 5th Ave, NY 10024, USA</span></li>
                                <li><img src="${pageContext.request.contextPath}/assets/img/icons/envelope.svg"
                                        alt="Icon"> <a href="mailto:info@skillgrodemo.com">info@skillgrodemo.com</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <div class="tg-header__top-right">
                                <div class="tg-header__phone">
                                    <img src="${pageContext.request.contextPath}/assets/img/icons/phone.svg"
                                        alt="Icon">Call us: <a href="tel:0123456789">+123 599 8989</a>
                                </div>
                                ...
                                <nav class="tgmenu__nav">
                                    <div class="logo">
                                        <a href="${pageContext.request.contextPath}/home"><img
                                                src="${pageContext.request.contextPath}/assets/img/logo/logo.svg"
                                                alt="Logo"></a>
                                    </div>
                                    <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-xl-flex">
                                        <ul class="navigation">
                                            <li><a href="${pageContext.request.contextPath}/home">Home</a></li>
                                            <li><a href="${pageContext.request.contextPath}/course-list">Courses</a>
                                            </li>
                                            <li><a href="${pageContext.request.contextPath}/blog">Blog</a></li>
                                            <c:if test="${sessionScope.account != null}">
                                                <li>
                                                    <a
                                                        href="${pageContext.request.contextPath}/dashboard-profile">Dashboard</a>
                                                </li>
                                            </c:if>
                                        </ul>
                                    </div>
                                    <div class="tgmenu__search d-none d-md-block">
                                        <form action="${pageContext.request.contextPath}/course-list" method="GET"
                                            ...
                                            <div class="select-grp">
                                                ...
                                                <select  class="form-select" name="categories" id="headerCategorySelect">
                                            ...
                                            <div class="input-grp">
                                                <input type="text" name="search" placeholder="Search For Course . . ." value="${param.search}">
                                        ...
                                        <ul class="list-wrap">
                                            <li class="wishlist-icon">
                                                <a href="cart.html" class="cart-count">
                                                    <img src="${pageContext.request.contextPath}/assets/img/icons/heart.svg"
                                                        class="injectable" alt="img">
                                                </a>
                                            </li>
                                            <li class="mini-cart-icon">
                                                <a href="${pageContext.request.contextPath}/cart" class="cart-count">
                                                    <img src="${pageContext.request.contextPath}/assets/img/icons/cart.svg"
                                                        class="injectable" alt="img">
                                                </a>
                                            </li>
                                            <li class="header-btn login-btn">
                                                <c:choose>
                                                    <c:when test="${sessionScope.account != null}">
                                                        <a
                                                            href="${pageContext.request.contextPath}/authen?action=logout">Log
                                                            out</a>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <a
                                                            href="${pageContext.request.contextPath}/authen?action=login">Log
                                                            in</a>
                                                    </c:otherwise>
                                                </c:choose>
                                            </li>
                                    ...
                                    <div class="mobile-login-btn">
                                        <a href="login.html"><img
                                                src="${pageContext.request.contextPath}/assets/img/icons/user.svg"
