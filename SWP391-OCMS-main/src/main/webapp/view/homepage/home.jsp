...
<html class="no-js" lang="en">
    ...
    <%-- Website template originally from themegenix --%>
    ...
    <head>
        ...
        <style>
            ...
            .banner__images .image-container {
                width: 90%;
                max-width: 500px;
                margin: 0 auto;
                position: relative;
            ...
            .banner__images .image-container:hover .main-img {
                opacity: 1;
            ...
            .banner__images:before {
                ...
                bottom: 30px;
                left: 30px;
                border: 2px solid rgba(63, 120, 224, 0.2);
                border-radius: 12px;
                z-index: 0;
            }
    ...
    <body>
        ...
        <jsp:include page="../common/home/header-home.jsp"></jsp:include>
            ...
            <main class="main-area fix">
                ...
                <section class="banner-area banner-bg tg-motion-effects" data-background="${pageContext.request.contextPath}/assets/img/banner/banner_bg.png">
                    <div class="container">
                        <c:choose>
                                    ...
                                    <div class="col-12">
                                        <div class="swiper banner-slider">
                                            <div class="swiper-wrapper">
                                                <c:forEach items="${activeSliders}" var="slider">
                                                        ...
                                                        <div class="row justify-content-between align-items-center">
                                                            <div class="col-xl-5 col-lg-6">
                                                                <div class="banner__content">
                                                                    ...
                                                                    <p data-aos="fade-right" data-aos-delay="600">${slider.notes}</p>
                                                                    <div class="banner__btn-wrap" data-aos="fade-right" data-aos-delay="800">
                                                                        <a href="${slider.backlink}" class="btn arrow-btn">Learn More <img src="${pageContext.request.contextPath}/assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="banner__images">
                                                                    <!-- Debug info (uncomment to check paths): ${pageContext.request.contextPath}/assets/img/slider/${slider.imageUrl} -->
                                                                    <div class="image-container">
                                                                        <img src="${pageContext.request.contextPath}/assets/img/slider/${slider.imageUrl}" alt="${slider.title}" class="main-img">
                                                                    </div>
                            ...
                            <c:otherwise>
                                <!-- Default banner content when no sliders are available -->
                                        ...
                                        <div class="banner__content">
                                            <h3 class="title tg-svg" data-aos="fade-right" data-aos-delay="400">
                                                ...
                                                <span class="position-relative">
                                                    <span class="svg-icon" id="banner-svg" data-svg-icon="${pageContext.request.contextPath}/assets/img/objects/title_shape.svg"></span>
                                            ...
                                            <div class="banner__btn-wrap" data-aos="fade-right" data-aos-delay="800">
                                                <a href="${pageContext.request.contextPath}/course-list" class="btn arrow-btn">Explore Courses <img src="${pageContext.request.contextPath}/assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                    ...
                    <div class="container-fluid">
                        <div class="marquee_mode">
                            <div class="brand__item">
                                <a href="#"><img src="${pageContext.request.contextPath}/assets/img/brand/brand01.png"
                                                 alt="brand"></a>
                                <img src="${pageContext.request.contextPath}/assets/img/icons/brand_star.svg"
                                     alt="star">
                            </div>
                            <div class="brand__item">
                                <a href="#"><img src="${pageContext.request.contextPath}/assets/img/brand/brand02.png"
                                                 alt="brand"></a>
                                <img src="${pageContext.request.contextPath}/assets/img/icons/brand_star.svg"
                                     alt="star">
                            </div>
                            <div class="brand__item">
                                <a href="#"><img src="${pageContext.request.contextPath}/assets/img/brand/brand03.png"
                                                 alt="brand"></a>
                                <img src="${pageContext.request.contextPath}/assets/img/icons/brand_star.svg"
                                     alt="star">
                            </div>
                            <div class="brand__item">
                                <a href="#"><img src="${pageContext.request.contextPath}/assets/img/brand/brand04.png"
                                                 alt="brand"></a>
                                <img src="${pageContext.request.contextPath}/assets/img/icons/brand_star.svg"
                                     alt="star">
                            </div>
                            <div class="brand__item">
                                <a href="#"><img src="${pageContext.request.contextPath}/assets/img/brand/brand05.png"
                                                 alt="brand"></a>
                                <img src="${pageContext.request.contextPath}/assets/img/icons/brand_star.svg"
                                     alt="star">
                            </div>
                            <div class="brand__item">
                                <a href="#"><img src="${pageContext.request.contextPath}/assets/img/brand/brand06.png"
                                                 alt="brand"></a>
                                <img src="${pageContext.request.contextPath}/assets/img/icons/brand_star.svg"
                                     alt="star">
                            </div>
                            <div class="brand__item">
                                <a href="#"><img src="${pageContext.request.contextPath}/assets/img/brand/brand07.png"
                                                 alt="brand"></a>
                                <img src="${pageContext.request.contextPath}/assets/img/icons/brand_star.svg"
                                     alt="star">
                            </div>
            ...
            <div class="container">
                ...
                <section class="courses-area section-pt-120 section-pb-90"
                    ...
                    <div class="container">
                                            ...
                                            <c:forEach items="${listCategory}" var="category">
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="tab-${category.id}" data-bs-toggle="tab"
                                                            ...
                                                            aria-controls="tab-pane-${category.id}" aria-selected="false">
                                                        ${category.name}
                                                    </button>
                                                </li>
                                            </c:forEach>
                        ...
                        <div class="tab-content" id="courseTabContent">
                            ...
                            <c:forEach items="${listCategory}" var="category">
                                <div class="tab-pane fade" id="tab-pane-${category.id}" role="tabpanel" aria-labelledby="tab-${category.id}">
                                    <div class="swiper" id="swiper-category-${category.id}">

                                        <div class="swiper courses-swiper-active">
                                            <div class="swiper-wrapper">
                                                <c:forEach items="${listCourse}" var="course"> 
                                                    <c:if test="${course.categoryId == category.id}">
                                                        <div class="swiper-slide">
                                                            <div class="courses__item shine__animate-item">
                                                                <div class="courses__item-thumb">
                                                                    <a href="${pageContext.request.contextPath}/course-details?id=${course.id}" class="shine__animate-link">
                ...
                <section class="newsletter__area">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-4">
                                <div class="newsletter__img-wrap">
                                    <img src="${pageContext.request.contextPath}/assets/img/others/newsletter_img.png"
                                         alt="img">
                                    <img src="${pageContext.request.contextPath}/assets/img/others/newsletter_shape01.png"
                                         alt="img" data-aos="fade-up" data-aos-delay="400">
                                    <img src="${pageContext.request.contextPath}/assets/img/others/newsletter_shape02.png"
                                         alt="img" class="alltuchtopdown">
                                </div>
                            </div>
                            <div class="col-lg-8">
                    ...
                    <div class="newsletter__shape">
                        <img src="${pageContext.request.contextPath}/assets/img/others/newsletter_shape03.png" alt="img"
                                ...
                                <div class="instructor__content-wrap">
                                    ...
                                    <div class="tg-button-wrap">
                                        <a href="instructors.html" class="btn arrow-btn">See All Instructors <img
                                                src="${pageContext.request.contextPath}/assets/img/icons/right_arrow.svg"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="instructor__item">
                                                <div class="instructor__thumb">
                                                    <a href="instructor-datails.html"><img
                                                            src="${pageContext.request.contextPath}/assets/img/instructor/instructor01.png"
                                                            alt="img"></a>
                                                </div>
                                                <div class="instructor__content">
                                                    <h2 class="title"><a href="instructor-datails.html">Mark
                                                            Jukarberg</a></h2>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="instructor__item">
                                                <div class="instructor__thumb">
                                                    <a href="instructor-datails.html"><img
                                                            src="${pageContext.request.contextPath}/assets/img/instructor/instructor02.png"
                                                            alt="img"></a>
                                                </div>
                                                <div class="instructor__content">
                                                    <h2 class="title"><a href="instructor-datails.html">Olivia Mia</a>
                                                    </h2>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="instructor__item">
                                                <div class="instructor__thumb">
                                                    <a href="instructor-datails.html"><img
                                                            src="${pageContext.request.contextPath}/assets/img/instructor/instructor03.png"
                                                            alt="img"></a>
                                                </div>
                                                <div class="instructor__content">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="instructor__item">
                                                <div class="instructor__thumb">
                                                    <a href="instructor-datails.html"><img
                                                            src="${pageContext.request.contextPath}/assets/img/instructor/instructor04.png"
                                                            alt="img"></a>
                                                </div>
                                                <div class="instructor__content">
                                                    <h2 class="title"><a href="instructor-datails.html">Sophia Ava</a>
                                                    </h2>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="faq__img-wrap tg-svg">
                                    ...
                                    <div class="faq__img">
                                        <img src="${pageContext.request.contextPath}/assets/img/others/faq_img.png"
                                             alt="img">
                                        <div class="shape-one">
                                            <img src="${pageContext.request.contextPath}/assets/img/others/faq_shape01.svg"
                            ...
                            <div class="col-lg-6">
                                <div class="faq__content">
                                    ...
                                    <p>Groove's intuitive shared inbox makes it easy for team members to organize,
                                        prioritize and.In this episode.</p>
                                    <div class="faq__wrap">
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse show"
                                                    ...
                                                    <div class="accordion-body">
                                                        <p>Groove's intuitive shared inbox makes it easy for team
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-xl-6">
                                <div class="section__title white-title text-center mb-50">
                                    ...
                                    <p>Groove's intuitive shared inbox makesteam members together <br> organize,
                                        prioritize and.In this episode.</p>
                                </div>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="features__item">
                                    <div class="features__icon">
                                        <img src="${pageContext.request.contextPath}/assets/img/icons/features_icon01.svg"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="features__item">
                                    <div class="features__icon">
                                        <img src="${pageContext.request.contextPath}/assets/img/icons/features_icon02.svg"
                                             class="injectable" alt="img">
                                    </div>
                                    <div class="features__content">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="features__item">
                                    <div class="features__icon">
                                        <img src="${pageContext.request.contextPath}/assets/img/icons/features_icon03.svg"
                                             class="injectable" alt="img">
                                    </div>
                                    <div class="features__content">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="features__item">
                                    <div class="features__icon">
                                        <img src="${pageContext.request.contextPath}/assets/img/icons/features_icon04.svg"
                                             class="injectable" alt="img">
                                    </div>
                                    <div class="features__content">
                        ...
                        <div class="instructor__item-wrap-two">
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="instructor__item-two tg-svg">
                                        <div class="instructor__thumb-two">
                                            <img src="${pageContext.request.contextPath}/assets/img/instructor/instructor_two01.png"
                                                 alt="img">
                                            <div class="shape-one">
                                                <img src="${pageContext.request.contextPath}/assets/img/instructor/instructor_shape01.svg"
                                        ...
                                        <div class="instructor__content-two">
                                            ...
                                            <p>To take a trivial example, which of us undertakes physical exercise yes
                                                is this happen here.</p>
                                            <div class="tg-button-wrap">
                                ...
                                <div class="col-xl-6">
                                    <div class="instructor__item-two tg-svg">
                                        <div class="instructor__thumb-two">
                                            <img src="${pageContext.request.contextPath}/assets/img/instructor/instructor_two02.png"
                                                 alt="img">
                                            <div class="shape-one">
                                                <img src="${pageContext.request.contextPath}/assets/img/instructor/instructor_shape01.svg"
                                                     alt="img" class="injectable">
